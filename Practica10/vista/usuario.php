    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a href="multa.php" class="btn btn-outline-secondary text-white">Ver estatus de multa</a>
                </li>
                <li class="nav-item">
                    <a href="../maps-master/index.html" class="btn btn-outline-secondary text-white"
                        style="margin-left: 15px">Ver
                        Estadios</a>
                </li>
    ...
    <section class="intro">
        <div class="column col-sm-10 offset-sm-2 col-md-9 offset-md-3 col-lg-8 offset-lg-4">
           ...
           ?>
            <tr>
                <td>
                    <img width="350" src="<?php echo ($row['ruta'])?>">
                </td>
            </tr>
        ...
        <center>
            <div class="container" style="font-family:copperplate"><br>
                ...
                <hr>
                <h5 style="font-family:copperplate"><b>Nota: </b>si estas vetado, ingresa a <b>ver estatus de multa</b>
